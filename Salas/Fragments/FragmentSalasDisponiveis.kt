...
import com.example.unilib.databinding.FragmentSalasDisponiveisBinding
import kotlinx.coroutines.launch
import java.util.Date


class FragmentSalasDisponiveis : BaseFragment() {

    private lateinit var binding: FragmentSalasDisponiveisBinding;
    ...
    override fun onCreateView(
        ...
        binding = FragmentSalasDisponiveisBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            try {
                ...
                salasList = lerSalas("DISPONIVEL", codUsuario.toString(), administrador);
                        ...
                        SalasAdapter(
                            ...
                            onItemClickListener = { sala ->
                                if (!modoEdicao) {
                                    ...
                                    this@FragmentSalasDisponiveis.requireActivity()
...
//                    mensagem = "Nenhuma sala disponível encontrada."
//                )
