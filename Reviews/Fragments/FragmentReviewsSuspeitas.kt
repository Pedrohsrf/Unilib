...
import com.example.unilib.databinding.FragmentReviewsSuspeitasBinding
...
class FragmentReviewsSuspeitas : BaseFragment() {
    private lateinit var binding: FragmentReviewsSuspeitasBinding;
    ...
    override fun onCreateView(
        ...
        binding = FragmentReviewsSuspeitasBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            listReviews = RotinasBD.lerReviewsSuspeitas(true)
            if (listReviews.isNotEmpty()) {
                reviewsAdapter = GerenciarReviewsAdapter(
                    requireContext(), listReviews, onItemClickListener = { review ->
